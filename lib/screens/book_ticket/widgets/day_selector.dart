...
import 'package:qflix/widgets/translate_animation.dart';
import 'package:flutter/material.dart';
import 'package:qflix/widgets/scaleup_animation.dart';
import 'package:qflix/widgets/translate_animation.dart';
...
class _DateDaySelectorState extends State<DateDaySelector> {
  ...
  void initState() {
    ...
    _page = 0;
    _pageController = PageController(initialPage: _page, viewportFraction: .23);
  }

  void _onPageChange(int index) {
    if (_page != index) {
      _current = _current.add(Duration(days: index - _page));
          ...
          child: ShadowedBox(
            child: PageView(
              ...
              children: List.generate(
                7, // Generate 7 days (current day and one week ahead)
                (index) {
                  ...
                  return Transform.rotate(
                    angle: angle,
                    child: DayCard(
                      dateTime: _current.add(Duration(days: index)),
...
// ShadowedBox and DayCard classes remain the same
